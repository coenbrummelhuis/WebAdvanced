<script>
    import {deleteAuctionItem} from "../js/item-controller.js";
    ...
    const deleteItem = async () => {
        ...
        notice[1] = "";
        try {
            await deleteAuctionItem(params.id, user);
            page.redirect("/");
        }catch (e) {
            notice[0] = true;
            notice[1] = e.message;
